...
ALTER TABLE train_analyse
    ADD CONSTRAINT fk_analyse_train_stats FOREIGN KEY (train_stats_id) REFERENCES train_stats (train_stats_id),
    ADD CONSTRAINT fk_analyse_train FOREIGN KEY (train_id) REFERENCES train (train_id);
