...
public class AnalyseService {
    ...
    public Analyse creatingTrainAnalyse() {
        String textForRegion = readKilometers.getTextToAnalyse();
        String bruttoTextToAnalyse = readKilometers.getBruttoTextToAnalyse();
        var string = Arrays.stream(bruttoTextToAnalyse.split("\\s")).toList();
